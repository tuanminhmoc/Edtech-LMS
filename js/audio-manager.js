...
(function () {
    ...
    const patterns = {
        ...
        intro: [[132, .34, .052, 'sine', 0, 310], [260, .09, .028, 'triangle', .12], [390, .08, .032, 'triangle', .22], [520, .11, .03, 'sine', .31], [440, .28, .042, 'sine', .39, 880], [760, .12, .028, 'triangle', .53], [1040, .2, .03, 'sine', .64], [1320, .12, .018, 'sine', .76]]
    };
